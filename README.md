...
2. Using the logger object behaves like normal print statements, are prefixed with "org.openhab.automation.pythonscripting" and marked with log level INFO, ERROR, WARN ...
...
3. In Addition, the rule based logger object, is prefixed with "org.openhab.automation.pythonscripting.\<RuleClassName\>"
...
[Core Actions](#module-openhabactions) of openHAB can be used via the actions module
...
| DateTimeTrigger          | DateTimeTrigger(item_name, time_only=False, offset=0, trigger_name=None)              |                                                                                                     |
| PWMTrigger               | PWMTrigger(dutycycle_item, interval, min_duty_cycle, max_duty_cycle, dead_man_switch, trigger_name=None) |                                                                                  |
...
| ItemScriptCondition      | ItemScriptCondition(script, condition_name=None)                                      |                                                                                                     |
...
| getChannelLinks          | \<instance\>.getChannelLinks()                                                        | Array of [openHAB ItemChannelLinks](https://www.openhab.org/javadoc/latest/org/openhab/core/thing/link/itemchannellink) |
| linkChannel              | \<instance\>.linkChannel(channel_uid, link_config = {})                               | [openHAB ItemChannelLink](https://www.openhab.org/javadoc/latest/org/openhab/core/thing/link/itemchannellink) |
| unlinkChannel            | \<instance\>.unlinkChannel(channel_uid)                                               | [openHAB ItemChannelLink](https://www.openhab.org/javadoc/latest/org/openhab/core/thing/link/itemchannellink) |
